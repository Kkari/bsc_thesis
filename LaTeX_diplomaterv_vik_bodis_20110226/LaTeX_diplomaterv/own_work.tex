...
Természetesen nem lehet méréseket végezni referencia adatok nélkül, ezért a CIFAR-10 és az MNIST adathalmazon is lefuttattam két ismert, minden nehézség nélkül használható osztályzó algoritmust. Az egyik a Logisztikus regresszió\cite{hosmer2000introduction} volt, a másik pedig az SVM\cite{cortes1995support}. Mindkettõ bemenetére közvetlen a kép pixeljeit tettem.
...
\item Vettem az elõjelét a keletkezett mátrix elemeinek.
