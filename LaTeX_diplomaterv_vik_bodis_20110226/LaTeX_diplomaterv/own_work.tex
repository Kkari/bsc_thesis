...
A különözõ optimizátorok összehasonlításáról az érdeklõdõek \url{http://sebastianruder.com/optimizing-gradient-descent} ezen a honlapon olvashatnak egy nagyon jó összefoglalást.
...
\begin{align} \label{fullyConnected}
