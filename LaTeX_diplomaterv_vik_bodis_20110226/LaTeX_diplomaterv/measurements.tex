...
Mint már említettem a saját GPU-mon probáltam ki, illetve sikerült adatokat szereznem egy nagyon erõs scientific acceleratoron futtatot mérésrõl\cite{scalingCNN}, a két eszköz paraméterei:
\begin{itemize}
...
A Legjobb eredmény amit konvoluciós hálózattal a CIFAR adathalmazon elértem az \emph{18}\% százalékos hiba volt, a fent ismertetett lokális válasz normált struktúrával, csak GPU-n 300'000 lépésen keresztûl tanítottam. Ez már egy egészen tisztességes eredménynek számít az adathalmazon.
